...
export const environment = {
  ...
  // client_url: http://localhost:8080/api/clientes
  client_url: base_uris.resource_server.domain + base_uris.resource_server.endpoints.client,
  // region_url: http://localhost:8080/api/clientes/regiones
  ...
  // client_page_url: http://localhost:8080/api/clientes/page/
  ...
  // client_upload_url: ttp://localhost:8080/api/clientes/upload
